...
export const VERSION = import.meta.env.WXT_TEARLINE_AUTO_BROWSER_DEV_VERSION || version
...
export const DEFAULT_SETTINGS = {
  // @ts-ignore
  apiHost: import.meta.env.WXT_TEARLINE_AUTO_BROWSER_DEV_VERSION ? AVAILABLE_HOSTS[0] : AVAILABLE_HOSTS[1],
